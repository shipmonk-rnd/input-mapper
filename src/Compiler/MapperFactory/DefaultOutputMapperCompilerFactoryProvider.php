...
class DefaultOutputMapperCompilerFactoryProvider implements OutputMapperCompilerFactoryProvider
{
    ...
    protected function create(): MapperCompilerFactory
    {
        ...
        return new DefaultOutputMapperCompilerFactory($this->createPhpDocLexer($config), $this->createPhpDocParser($config));
    }
