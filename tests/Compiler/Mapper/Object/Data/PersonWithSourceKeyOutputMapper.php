 ...
 *
 * @implements OutputMapper<PersonWithSourceKeyInput>
 */
class PersonWithSourceKeyOutputMapper implements OutputMapper
{
    ...
    {
        return ['id' => $this->mapId($data->id, [...$path, 'id']), 'full_name' => $this->mapName($data->name, [...$path, 'name'])];
    }
